...
import { Activity, AlertTriangle, CloudRain, Flame, Radio, Satellite, Ship, Plane, Newspaper, ShieldCheck, Database, Crosshair, RefreshCw, X, Siren } from 'lucide-react';
...
type Overview = {
  generatedAt: string; events: IntelEvent[]; counts: Record<string, number>;
  health?: { status?: string; feeds?: Record<string, string>; liveFeedCount?: number; totalFeeds?: number };
  optionalIntegrations?: Record<string, string>;
};
